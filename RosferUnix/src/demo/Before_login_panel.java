...
static	Color text_color=new Color(0x6f7687);
	...
	private void design1()
	{
		...
		version.setBounds(110, 4, 150, 15);
...
//		min.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(0,1,0,0,new Color(0x212530)),BorderFactory.createMatteBorder(0,1,0,0,new Color(0x4b4f5a))));
		close.setBounds(130,0, 20, 20);
		close.setBackground(bg_color);
//		close.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createMatteBorder(0,1,0,0,new Color(0x212530)),BorderFactory.createMatteBorder(0,1,0,0,new Color(0x4b4f5a))));
