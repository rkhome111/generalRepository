...
public class LoginWindow extends Dialog implements MouseListener,KeyListener,MouseMotionListener
{
...
//		JPasswordField password_tf;
	 ...
	 public void keyPressed(KeyEvent e)
	{
		...
		if(e.getKeyCode()==10)
		{
			if(rosfer.liw!=null && e.getSource()==rosfer.liw.comment)
			{
				rosfer.liw.requestFocusInWindow();
			}
			else
			{
